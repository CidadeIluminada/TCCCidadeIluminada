...
\begin{figure}[!htbp]
 \centering
  ...
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-nova-chamada}Tela de nova chamada}
    \includegraphics[scale=0.1]{android/2.png}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

\ref{tela-inicial} \ref{tela-nova-chamada}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-nova-chamada-foto-poste}Tela de chamada com a foto do poste}
  ...
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-gps}Tela de seleção de endereço via GPS}
    \includegraphics[scale=0.1]{android/4.png}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

\ref{tela-nova-chamada-foto-poste} \ref{tela-gps}

\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-nova-chamada-endereco}Tela de chamada com o endereço preenchido automaticamente}
  ...
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-enviando}Tela de envio de protocolo com o envio em progresso}
    \includegraphics[scale=0.1]{android/6.png}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

\ref{tela-nova-chamada-endereco} \ref{tela-enviando}

\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-lista-chamadas}Tela de lista de protocolos feitos}
  ...
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-detalhes-chamada}Tela de detalhes de protocolo}
    \includegraphics[scale=0.1]{android/9.png}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

\ref{tela-lista-chamadas} \ref{tela-detalhes-chamada}

\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{tela-preferencias}Tela de configuração de preferências}
    \includegraphics[scale=0.1]{android/7.png}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

\ref{tela-preferencias}
Segue ilustrações mostrando o fluxo de utilização do aplicativo Android.
